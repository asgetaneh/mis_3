    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <h1 class="logo me-auto">
          <a href="index.html"
            ><img src="assets/img/logo.png" class="img-fluid" alt="" />JU
            SMIS</a
          >
        </h1>
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="#portfolio">Plan</a></li>
            <li><a class="nav-link scrollto" href="#team">Feedback</a></li>
            <li class="dropdown">
              <a href="#"
        ...
        <section id="faq" class="faq section-bg">
          <div class="container aos-init aos-animate" data-aos="fade-up">
            <div class="section-title">
              ...
              <p>
                Here are the most asked questions regarding the MIS
              </p>
            </div>
