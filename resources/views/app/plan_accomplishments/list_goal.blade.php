...
<div class="row justify-content-center mt-3">
            ...
            <div class="card-body border rounded" style="background-color: #e9ecef;">
                <form action="{{ route('login') }}" method="post">
                    ...
                    <tbody>
                        ...
                        <tr>
                            {{-- <td> --}}
                                 <a class="border border-secondary btn btn-light btn-block text-left {{ Request::is('smis/plan/get-objectives/'.$goal->id) ? 'bg-primary' : '' }}" href="{{ route('get-objectives', $goal->id) }}" role="button" aria-expanded="false" aria-controls="collapseExample">
                                {{
    ...
    <div class="col-md-10">
         ...
         <div class="card" class="collapse">
            <div class="card-header bg-light">Strategic Management Information System (SMIS) - Planning Area</div>
            <div class="card-body">
                   {{-- <table class="table table-borderless table-hover">
                    <tbody>
