...
<div class="row">
    ...
    <x-inputs.group class="col-sm-12">
        ...
        <x-inputs.select required class="select2" multiple="multiple" name="kpiThreeLists[]" data-placeholder="Select disaggregation level three" label="Disaggregation Three">
