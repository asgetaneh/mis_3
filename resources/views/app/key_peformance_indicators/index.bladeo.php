                            ...
                            @if (app()->getLocale() == $keyPeformanceIndicator->locale)
                                <tr>
                                    ...
                                    @php
                                        $kpiType = '';
                                        foreach (
                                            $keyPeformanceIndicator->keyPeformanceIndicator->kpiType
                                                ->kpiTypeTranslations
                                            as $key => $value
                                        ) {
                                    ...
                                    @php
                                        $strategy = '';
                                        foreach (
                                            $keyPeformanceIndicator->keyPeformanceIndicator->strategy
                                    ...
                                    @php
                                        $reportingPeriodType = '';
                                        foreach (
                                            $keyPeformanceIndicator->keyPeformanceIndicator->reportingPeriodType
