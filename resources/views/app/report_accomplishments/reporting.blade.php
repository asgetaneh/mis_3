                    ...
                    <div class="mb-3 row">
                        <table class="table table-borderless table-hover">
                            <tbody>
                                ...
                                <tr>
                                    {{-- <td class="rounded "> --}}
                                    <a style="background-color: #f5f5f5;" class="border border-secondary btn btn-light btn-block text-left {{ Request::is('smis/report/get-objectives-reporting/' . $goal->id) ? 'bg-primary' : '' }}" href='{{ route('get-objectives-reporting', $goal->id) }}' role="button" aria-expanded="false" aria-controls="collapseExample">
