                ...
                <table class="table table-borderless table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ optional($suitableKpi->office)->id ?? '-' }}
                            </td>
                            <td>
                            ...
                            <td class="text-center" style="width: 134px;">
                                <div
                                    ...
                                    class="btn-group"
                                >
                                    @can('update', $suitableKpi)
                                    <a
                                        href="{{ route('suitable-kpis.edit', $suitableKpi) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    @endcan @can('view', $suitableKpi)
                                    <a
                                        href="{{ route('suitable-kpis.show', $suitableKpi) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">{!! $suitableKpis->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
