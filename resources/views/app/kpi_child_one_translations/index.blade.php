@extends('layouts.app')
@section('title', 'KPI Level One Index')
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    @endcan @can('view',
                                    $kpiChildOneTranslation)
                                    <a
                                        href="{{ route('kpi-child-one-translations.show', $kpiChildOneTranslation) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    $kpiChildOneTranslation)
                                    <form
                                        action="{{ route('kpi-child-one-translations.destroy', $kpiChildOneTranslation) }}"
                                        method="POST"
