        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    <a
                                        href="{{ route('kpi-child-two-translations.show', $kpiChildTwoTranslation) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    $kpiChildTwoTranslation)
                                    <form
                                        action="{{ route('kpi-child-two-translations.destroy', $kpiChildTwoTranslation) }}"
                                        method="POST"
                ...
                <div class="float-right">
                    {!! $kpiChildTwoTranslations->render() !!}
                </div>
            </div>
        </div>
    </div>
