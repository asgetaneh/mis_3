@php $editing = isset($keyPeformanceIndicatorTranslation) @endphp
...
<div class="row">
    <x-inputs.group class="col-sm-12">
        <x-inputs.text
            name="name"
            label="Name"
            :value="old('name', ($editing ? $keyPeformanceIndicatorTranslation->name : ''))"
            maxlength="255"
            placeholder="Name"
            required
        ></x-inputs.text>
    ...
    <x-inputs.group class="col-sm-12">
        <x-inputs.select
            ...
            required
        >
            @php $selected = old('translation_id', ($editing ? $keyPeformanceIndicatorTranslation->translation_id : '')) @endphp
