        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    ...
                    <tbody>
                        @forelse($keyPeformanceIndicatorTranslations as
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width: 134px;">
                                ...
                                >
                                    ...
                                    $keyPeformanceIndicatorTranslation)
                                    <a
                                        href="{{ route('key-peformance-indicator-translations.edit', $keyPeformanceIndicatorTranslation) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    $keyPeformanceIndicatorTranslation)
                                    <a
                                        href="{{ route('key-peformance-indicator-translations.show', $keyPeformanceIndicatorTranslation) }}"
                                    >
                                        <button
                                            type="button"
                                            class="btn btn-light"
                                    ...
                                    $keyPeformanceIndicatorTranslation)
                                    <form
                                        action="{{ route('key-peformance-indicator-translations.destroy', $keyPeformanceIndicatorTranslation) }}"
                                        method="POST"
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">
                                {!!
                                $keyPeformanceIndicatorTranslations->render()
                                !!}
                            </td>
                        </tr>
                    </tfoot>
