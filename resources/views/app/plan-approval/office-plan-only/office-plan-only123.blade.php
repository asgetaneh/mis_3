 ...
 @forelse(getQuarter($planAcc->Kpi->reportingPeriodType->id) as $period)
    ...
    @foreach ($planAcc->Kpi->kpiChildTwos as $two)
            ...
            @php
                ...
                $plan123 = planIndividual($planAcc->Kpi->id, $one->id, $two->id,$kpiThree->id,$office,$period->id, 2);
    ...
    @endforeach
        ...
        @php
            ...
            $planSumch2Total = planIndividualChTwoSum($planAcc->Kpi->id,  $two->id,$office,$period->id, 2);
            @endphp
            {{$planSumch2Total}}
            </td>
    ...
    <tr>
        ...
        @foreach ($planAcc->Kpi->kpiChildOnes as $one)
            ...
            @php
                ...
                $planSumch1ch3 = planIndividualChOnechThreeSum($planAcc->Kpi->id, $one->id, $two->id,$kpiThree->id,$office, 2);
                @endphp
                    {{$planSumch1ch3}}
            </td>
        @endforeach
