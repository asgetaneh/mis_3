 ...
 @forelse(getQuarter($planAcc->Kpi->reportingPeriodType->id) as $period)
    ...
    @endforeach
        ...
        @php
            ...
            $planSumch2_array = array_merge( $hasChildrenOfficesPlannedAndApproved, array($office->id));
    ...
    <tr>
        ...
        @foreach ($planAcc->Kpi->kpiChildOnes as $one)
            ...
            @php
                ...
                $offices_array = array_merge($hasChildrenOfficesPlannedAndApproved, array($office->id));

                $planSumch1ch3 = planIndividualChOnechThreeSumApproved($planAcc->Kpi->id, $one->id, $two->id,$kpiThree->id,$offices_array);
                // $planSumch1ch3 = planIndividualChOnechThreeSumApproved($planAcc->Kpi->id, $one->id, $two->id,$kpiThree->id,$office);
                @endphp
                    {{$planSumch1ch3}}
            </td>
        @endforeach
